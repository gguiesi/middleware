...
from siam.views import index, getEnv, authUser, contactUs, executeAction, \
    getDevByEnv, getMonitorByDev, getReportByDev, getReport, getProfile, panicActive, \
    panicInfo, setDevice, setProfileActive, getStatusByDev, getMessageReport, \
    getPassKey, getTpDev, newPassword, sendPassword
